...
<head>
    ...
    <title>@yield('title', 'OscarNet')</title> <!-- Título dinámico -->
    <link rel="stylesheet" href="{{ asset('css/app.css') }}"> <!-- Enlace a los estilos compilados por Mix -->
    ...
    <style>
        ...
        .btn-register {
            background-color:rgb(166, 248, 145);
            color: #fff;
            border: none;
        }

        .btn-register:hover {
            background-color:rgb(113, 165, 129);
        }
